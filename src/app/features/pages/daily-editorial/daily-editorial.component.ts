...
export class DailyEditorialComponent implements OnInit {
  ...
  public onFileChange(event: any): void {
    ...
    this.dailyEditorialForm.patchValue({
      pdf: this.selectedFiles['pdf'],
      video: this.selectedFiles['video'],
    });
    event.target.value = '';
  }
  ...
  createEditorial() {
    const reqBody: any = {
      files: [
        this.dailyEditorialForm.get('pdf')?.value,
        this.dailyEditorialForm.get('video')?.value,
